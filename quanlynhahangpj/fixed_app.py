...
def edit_food(food_id):
    ...
    if chef_id and chef_id.strip() != "":
        food.chef_id = int(chef_id)
    else:
        food.chef_id = None

    # staff ids
    staff_list = request.form.getlist('staff_ids')

    if staff_list:
        food.staff_ids = ",".join(staff_list)
    else:
        food.staff_ids = ""
...
def add_review(food_id):
    ...
    return redirect(url_for('food_detail', id=food_id))
